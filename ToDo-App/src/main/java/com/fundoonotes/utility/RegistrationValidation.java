...
/**
 * Purpose: This class is for validating a user at the time of registration
 * 
 * @author SANA SHAIKH
 * @since 21Mar 2018
 */
...
public class RegistrationValidation implements Validator
{
   ...
   private static final Pattern NAME_REGEX = Pattern.compile("^[a-zA-z0-9]{3,}");
   ...
   private static final Pattern PASSWORD_REGEX = Pattern.compile("[a-z0-9]{3,}");
   ...
   public void validate(Object target, Errors errors)
   {
      ...
      if (userdto.getPassword() != null && !PASSWORD_REGEX.matcher(userdto.getPassword()).matches()) {
         errors.reject("password", "User Password cannot be empty contains letter and atleast 3digits..");
      }
